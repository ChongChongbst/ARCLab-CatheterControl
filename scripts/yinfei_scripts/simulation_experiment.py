...
class SimulationExperiment:
    ...
    def set_general_parameters(self, p_0, r, n_mid_points, l):
        ...
        Args:
            ...
            r (float): cross section radius of catimage_save_pathheter
    ...
    def execute(self):
        ...
        #vis_path = os.path.join(path_settings.image_save_dir, 'vis.png')
        #catheter.visualize_targets(vis_path)

        if self.use_reconstruction or self.use_2d_pos_target:
            bezier_specs_old = catheter.calculate_image_save_path
        for i in range(self.n_iter):
            ...
            # use blender to render the bezier curves
